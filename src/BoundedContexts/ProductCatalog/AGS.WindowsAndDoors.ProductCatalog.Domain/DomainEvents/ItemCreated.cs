...
/// <summary>
/// Domain event raised when a new catalog item is created.
/// </summary>
public record ItemCreated : IDomainEvent
{
    /// <summary>
    /// The code of the created item.
    /// </summary>
    ...
    public ItemCreated(string itemCode, string itemId)
    {
